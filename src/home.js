      ...
      >
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-400 mb-12 leading-relaxed ">
            Full Stack Developer with expertise in React, Redux, Material-UI, Node.js, Express, and MySQL. Skilled in building responsive, secure, and scalable web applications.
          </p>
